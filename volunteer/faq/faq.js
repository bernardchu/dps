  ...
  sections: [
    {
      ...
      imgUrl: "http://dps-festive.imgix.net/images/volunteer/volunteer-tanner.jpg?h=340&fit=crop&w=340",
      prose: [
        ...
        '<p class="volunteer-application-link"><a href="https://docs.google.com/forms/d/e/1FAIpQLSdzuj9xzneUvENq6TgFLZxAxVBM1BzZrdU2Jrut6iXRMcTwFg/viewform">Please Fill Out This Application to Get Started!</a></p>'
      ]
    },
    {
      heading: "What Will I Do?",
      imgUrl: "http://dps-festive.imgix.net/images/volunteer/volunteer-abby.jpg?h=340&fit=crop&w=340",
      prose: [
        "<p>We need help with all sorts of things, including: Transporting dogs to and from events, to vet and grooming appointments Posting on social media multiple times a day to highlight our animals, our events, and the rescue Promoting our dogs on sites like Craigslist and Nextdoor to increase their chances at adoption Searching the Internet for dogs in need of rescuing that we can help Volunteering at our bi-weekly adoption events (set up, tear down, walking dogs, cleaning, talking to adopters) Volunteering at our larger annual expo events (similar to our bi-weekly events, but generally needs even more coordination and set up/tear down.)</p>"
      ]
    },
    {
      heading: "What do I do at your events?",
      imgUrl: "http://dps-festive.imgix.net/images/volunteer/volunteer-sol.jpg?h=340&fit=crop&w=340",
      prose: [
    ...
    },
    {
      ...
      imgUrl: "http://dps-festive.imgix.net/images/volunteer/volunteer-andy.jpg?h=340&fit=crop&w=340",
      prose: [
