...
export default class DpsAboutFaq extends React.PureComponent {
  private static sections: IDpsFaqSection[] = [
    ...
    },
    {
      ...
      prose: [
        "<p>We are not a shelter or a kennel. Our dogs are rescued from high kill shelters and then go into a network of foster homes in Northern CA, Southern CA and Las Vegas. Each dog lives with a family or person until they find their permanent home.</p>"
      ]
    },
    {
    ...
    },
    {
      ...
      prose: [
        "<p>As a rule, we do not have trial periods. If you take a dog home on a trial basis for a week or two and do not end up adopting, we have not been able to use that time to find that dog a permanent home. We don't think it's fair for the dog or for the other families that may want to adopt.</p>",
      ]
    },
    {
      ...
      prose: [
        '<p>Please look at our <a href="../../adopt/dog-application/">apply page</a></p>',
      ]
    }
  ]
  ...
  public render() {
    return (
      <div className="row">
        <DpsFaq sections={DpsAboutFaq.sections} />
      </div>
    );
  }
}
