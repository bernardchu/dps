        ...
        <div className="row in-honor-of">
          <div className="col-md-8 col-sm-12">
            ...
            <p>
              ...
              Step 2: Email <a href="mailto:donna@dpsrescue.org">donna@dpsrescue.org</a> with a photo (if you'd like to submit one) and a message (ex: In memory of my beloved Fluffy, adopted in 2002)
            </p>
