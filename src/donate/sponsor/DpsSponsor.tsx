      ...
      <>
        <div className="sponsor donate row">
          <div className="col-md-8 col-sm-6 col-xs-12">
            ...
            <p>Step 3: Send an email to <a href="mailto:info@dpsrescue.org">info@dpsrescue.org</a> with the name of the dog you’d like to sponsor and a short message (ex: Sponsored by Sarah in honor of her dog Rex)</p>
            <br />
