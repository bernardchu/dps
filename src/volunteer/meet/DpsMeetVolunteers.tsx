...
interface IDpsMeetVolunteersProps {
 ...
 */
export default class DpsMeetVolunteers extends React.PureComponent<IDpsMeetVolunteersProps> {
  public render() {
    const { directors, primary, secondary } = this.props;
    return (<>
      <h2>Meet Our Volunteers</h2>
      <div className={`row ${styles.secondary} ${styles['volunteer-section']}`}>
        {secondary.map(volunteer => <div className={`${styles['secondary-volunteer']} col-md-4 col-sm-6 row`} key={volunteer.photo}>
          <div className={`col-xs-4 ${styles['secondary-volunteer-image']}`}>
            <div className={styles['image-circle-cropper']}>
              <img src={volunteer.photo} alt={volunteer.name} className="no-border" />
            </div>
          </div>
          <div className={`col-xs-8 ${styles['secondary-volunteer-details']}`}>
      ...
      <div className={`row ${styles.directors} ${styles['volunteer-section']}`}>
        <h2>Board of Directors and Executive Officers</h2>
        {directors.map(director => <div className={`${styles['secondary-volunteer']} col-md-4 col-sm-6 row`} key={director.photo}>
          <div className={`col-xs-4 ${styles['secondary-volunteer-image']}`}>
            <div className={styles['image-circle-cropper']}>
