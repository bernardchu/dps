  ...
  private static sections: IDpsFaqSection[] = [
    {
      ...
      imgUrl: "https://dps-festive.imgix.net/images/volunteer/volunteer-tanner.jpg?h=340&fit=crop&w=340",
      prose: <>
        ...
        <p className="application-link"><a href="https://docs.google.com/forms/d/e/1FAIpQLSdzuj9xzneUvENq6TgFLZxAxVBM1BzZrdU2Jrut6iXRMcTwFg/viewform">Fill Out This Application to Get Started!</a></p>
      </>
    },
    {
      heading: "What Will I Do?",
      imgUrl: "https://dps-festive.imgix.net/images/volunteer/volunteer-abby.jpg?h=340&fit=crop&w=340",
    ...
    },
    {
      ...
      imgUrl: "https://dps-festive.imgix.net/images/volunteer/volunteer-sol.jpg?h=340&fit=crop&w=340",
      prose: <>
    ...
    },
    {
      ...
      imgUrl: "https://dps-festive.imgix.net/images/volunteer/volunteer-andy.jpg?h=340&fit=crop&w=340",
      prose: <>
    ...
    return (
      <div className="row">
        <div className="volunteer-header-images hidden-xs hidden-sm">
          <Imgix
            src="https://dps-festive.imgix.net/images/volunteer/volunteer-header-marlina1.jpg"
            imgixParams={{
              rect: '0,0,4700,4000',
              fm: 'pjpg',
              fit: 'fill',
          ...
          />
          <Imgix
            src="https://dps-festive.imgix.net/images/volunteer/volunteer-header-group1.jpg"
            imgixParams={{
          ...
          />
          <Imgix
            src="https://dps-festive.imgix.net/images/volunteer/volunteer-header-group2.jpg"
            imgixParams={{
