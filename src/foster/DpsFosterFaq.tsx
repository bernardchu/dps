  ...
  private static sections: IDpsFaqSection[] = [
    ...
    },
    {
      ...
      prose: <>
        ...
        <p>Our one exception to our foster-to-adopt policy is our Pick of the Litter Program. <a href="https://docs.google.com/document/d/1TKR9BqHWlgKaNAMYFzvotE1xvvr-xJhKGSvOZav8OkE/edit#heading=h.lmpsosxuk96p" target="_blank" rel="noreferrer">Click here to read more.</a></p>
      </>
    }
  ];
