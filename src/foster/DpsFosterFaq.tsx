...
export default class DpsFosterFaq extends React.PureComponent {
  private static sections: IDpsFaqSection[] = [
	...
	<p className="application-link"><a href="https://docs.google.com/forms/d/1V_XHxL5NpasEI2eCC-IEsaXX6hVDv3-w6vXc_jxxAjI/edit">Click here to apply to foster kittens</a></p>
