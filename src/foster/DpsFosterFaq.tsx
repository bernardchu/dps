  ...
  private static sections: IDpsFaqSection[] = [
    {
      ...
      imgUrl: "/images/foster/foster-melissa.jpg?h=340&fit=crop&w=340",
      prose: <>
    ...
    },
    {
      ...
      imgUrl: "/images/foster/foster-rachel.jpg?h=340&fit=crop&w=340&crop=top",
    ...
    },
    {
      ...
      imgUrl: "/images/foster/foster-foster.jpg?h=340&fit=crop&w=340",
    ...
    },
    {
      ...
      imgUrl: "/images/foster/foster-avery.jpg?h=340&fit=crop&w=340&crop=top",
    ...
    },
    {
      ...
      imgUrl: "/images/foster/faq/tips-for-getting-your-foster-pup-adopted.pdf?p=1&h=340&w=340&fit=crop&crop=top&pad=20&bg=A83F3B",
      prose: <>
        ...
        <ol>
          <li><strong><a href={`https://${imgixDomain}/images/foster/faq/tips-for-getting-your-foster-pup-adopted.pdf`}>Tips for Getting your Foster Dog Adopted</a>:</strong> This handout contains advice, tips and tricks for helping DPS to market your foster dog and find them the right forever home.</li>
          <br />
          <li><strong><a href={`https://${imgixDomain}/images/foster/faq/foster-enrichment-101.pdf`}>Enrichment 101</a>:</strong> We know that everyone works full time and can&apos;t spend hours and hours doing training every day. This handout has some fun ideas for keeping your foster dog mentally and physically stimulated. It&apos;s just as important to tire out their minds as their bodies, so supplement daily walks with these activities for a well-rounded and calm foster dog!</li>
          <br />
          <li><strong><a href={`https://${imgixDomain}/images/foster/faq/crate-training.pdf`}>Crate Training</a>:</strong> Crate training is highly recommended for all dogs and puppies! Here is a step-by-step guide to teaching your foster pup to love their crate.</li>
          <br />
          <li><strong><a href={`https://${imgixDomain}/images/foster/faq/dps-puppy-packet.pdf`}>Puppy Manual</a>:</strong> Puppies can be a tremendous amount of fun, but they can also be exhausting! This manual contains many activities you can engage in with your foster puppy. Puppies are in a crucial socialization period of their lives; follow these tips to help DPS adopt out well-rounded and social puppies who will thrive in their adoptive homes!</li>
          <br />
          <li><strong><a href={`https://${imgixDomain}/images/foster/faq/shy-dogs.pdf`}>Tips and Tricks for Shy Dogs</a> and <a href={`https://${imgixDomain}/images/foster/faq/treat-and-retreat.pdf`}>Treat and Retreat</a></strong></li>
        </ol>
      </>
    }
  ];
